...
<head>
    ...
    <link href="../css/style.css" rel="stylesheet"> <!-- 引入自定义的CSS文件 -->
    <script src="../js/common.js"></script> <!-- 引入自定义的JS文件 -->
  </body>
</html>
</head>
<body>
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="match.php">Match</a></li>
          </ul>
        </li>
        <li class="nav-item">
...
<div>
  <div class="d-flex justify-content-center">
    <img src="img/olympics.png" class="img-fluid" alt="...">
  </div>
</div>
</header>